...
class AppDocumentUserHydrator implements HydratorInterface
{
    ...
    public function hydrate(object $document, array $data, array $hints = array()): array
    {
        ...
        /** @Field(type="string") */
        if (isset($data['additional']) || (! empty($this->class->fieldMappings['additional']['nullable']) && array_key_exists('additional', $data))) {
            $value = $data['additional'];
            if ($value !== null) {
                $typeIdentifier = $this->class->fieldMappings['additional']['type'];
                $return = (string) $value;
            } else {
                $return = null;
            }
            $this->class->reflFields['additional']->setValue($document, $return);
            $hydratedData['additional'] = $return;
        }
        return $hydratedData;
    }
}